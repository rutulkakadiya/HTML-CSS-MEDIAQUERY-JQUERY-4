var swiper = new Swiper(".mySwiper1", {
  ...
  $(document).ready(function()
  {
    ...
    $("#s58").mouseenter(function(){
        $("#iframe1").css("display","block")
    })
    
    $("#s58").mouseleave(function(){
...
{
    $('header').toggleClass('background',$(this).scrollTop()>700);
});
